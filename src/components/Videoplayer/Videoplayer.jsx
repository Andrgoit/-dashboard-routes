...
const Videoplayer = () => {
  const [urlSelectedMovie, setUrlSelectedMovie] = useState(null);
  // const [isOpenVideoplayer, setIsOpenVideoplayer] = useState(true);

  // const toggleVideoplayerButton = () => {
  //   setIsOpenVideoplayer(!isOpenVideoplayer);
  // };

  const selectVideo = link => {
    setUrlSelectedMovie(link);
  };
...
// class oldVideoplayer extends Component {
//   state = {
